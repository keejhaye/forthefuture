                        ...
                        <div class="input-group-btn">
                            <form class="form-horizontal" role="form" >
                                <div class="form-group">
                                    ...
                                    <input type="text" id="keyword" name="keyword" ng-model="search.name" class="form-control" placeholder="Keyword">
                                </div>  
                                <div class="form-group">
                                <input type="text" id="service" ng-model="search.service_id" name="service" placeholder="Service Name" class="form-control">
                            </div>
