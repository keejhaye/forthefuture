...
function HeaderController($scope, $http,API_URL, Statistics, $document, $socket, $window, $timeout, $interval, $mdDialog, $mdToast) {
    ...
    $document.ready(function(){
      ...
      $interval(function(){
         $http.get(API_URL + "routine/users/update_last_ping")
	...
	$socket.on('initial_statistics', function(data){
        ...
        $scope.statistics['chatting_count'] = (data[5] == null ? 0 : Number(data[5])) 

        user_stat = JSON.parse(data[6])
